...
('18b05550a0550f5045b78d591c2662556f51fbfa9781cbd8a0f5b7ad78d4215c90cebb815288bd5e', 1, 1, 'tteportal', '[]', 0, '2025-04-22 14:17:08', '2025-04-22 14:17:08', '2026-04-22 19:47:08'),
('8eaad969db7a4e6eda524a804a4fe2262affe096f8d23fc708078042ac905ae0bbf5e82707add7f7', 1, 1, 'tteportal', '[]', 0, '2025-04-22 14:17:01', '2025-04-22 14:17:03', '2026-04-22 19:47:01'),
('afe491fc5a08b9f5a0cc5ec4eeae72f23ff22064fd2ce30b8452c0da102996ea090dac38af07e483', 1, 1, 'tteportal', '[]', 0, '2025-04-23 10:13:49', '2025-04-23 10:13:50', '2026-04-23 15:43:49'),
('d8b2eac2c3c3bebc022e5eb5849858a55b18d31e4e42498d3a2a402c2778b489e813a4edd39424bb', 1, 1, 'tteportal', '[]', 0, '2025-04-24 04:08:03', '2025-04-24 04:08:04', '2026-04-24 09:38:03');
...
--
-- Table structure for table `travelling_allowances`
--

DROP TABLE IF EXISTS `travelling_allowances`;
CREATE TABLE IF NOT EXISTS `travelling_allowances` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `travelling_allowances`
--

INSERT INTO `travelling_allowances` (`id`, `from_date`, `arrived_date`, `train_id`, `from_station`, `to_station`, `hrs_out_of_hq`, `amt`, `ta_percentage`, `object_of_journey`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
(1, '2023-11-01 06:45:00', '2023-11-01 09:30:00', '4', 4, 48, NULL, NULL, NULL, '0000-00-00 00:00:00', 1, 3, '2023-11-15 20:26:36', NULL),
(2, '2023-11-01 07:30:00', '2023-11-01 10:30:00', '5', 8, 62, NULL, NULL, NULL, '0000-00-00 00:00:00', 1, 3, '2023-11-15 20:26:36', NULL);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `insentive_amount` decimal(10,2) DEFAULT NULL,
  `insentive_percentage` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `user_type`, `username`, `email`, `email_verified_at`, `password`, `first_name`, `last_name`, `father_name`, `date_of_birth`, `date_of_joining`, `branch_id`, `divison_id`, `designation_id`, `station_head_quarter_id`, `mobile_no`, `authority_no`, `first_class_duty_card_no`, `ta_sr_no`, `insentive_amount`, `insentive_percentage`, `pay_band`, `g_pay`, `expiry_date`, `timezone`, `is_active`, `created_by`, `deactive_date`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'A', 'superadmin', 'roshan@dreamweaversindia.com', NULL, '$2y$10$BXjmhHhw2jhBmyEDzYcaAuJCibSdluTa6qAkelbYe61t0ooGM10.K', 'Super', 'Admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1234567890', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, '2025-04-19 11:22:13', '2025-04-19 11:22:13');
COMMIT;
